...
const translations = {
  ...
  km: {
    ...
    intro_copy: "ខ្ញុំជំនាញលើ Node.js, NestJS, TypeScript, TypeORM, PostgreSQL, MySQL, Express, Git, Docker, Laravel, និងច្រើនទៀត។ ជំនាញរបស់ខ្ញុំរួមមានប្រព័ន្ធគ្រប់គ្រងធនធានមនុស្ស វេទិកាការងារ ការអភិវឌ្ឍន៍ API និងស្ថាបត្យកម្មមូលដ្ឋានទិន្នន័យ។ ខ្ញុំប្តេជ្ញាសរសេរកូដដែលស្អាត និងងាយស្រួលថែទាំ ដើម្បីដោះស្រាយបញ្ហាអាជីវកម្មជាក់ស្តែង។",
